...
:pledge_asset_symbol: 抵押资产符号（只能抵押YOYO）
:url: 平台的地址URL
:extra_data:  扩展信息（可以是平台提供的api访问接口）
:broadcast:  是否广播
...
2.4.14 list_platforms
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
列出当前有效的平台清单，无论得票或者抵押有多少。
...
:voting_account:  投票人账号（UID或昵称）
:platforms_to_add:  增加支持的平台清单
:platforms_to_remove:   去除支持的平台清单
:broadcast:  是否广播
...
::
    asset_options {
          ...
          // 当这个资产在市场上交易时，这个交易总额的百分比将被提取并支付给发行人。 这是一个固定点值，代表百分之一百，即在此字段中值为100意味着此资产的市场交易收取1％的费用。
          market_fee_percent = 0;
          // 以交易量的 market_fee_percent计算的市场费用限制为此值
...
::
    ...
    wscat -c ws://localhost:8091
    {"id":1, "method":"call", "params":[0, "create_asset", ["250926091", "WOWO", 4, {}, true]]}
...
::
  ...
  {
    "ref_block_num": 53840,
    "ref_block_prefix": 866309011,
    "expiration": "2018-05-03T07:37:45",
    "operations": [[
        25,{
          "fee": {
            "total": {
    ...
    "signatures": [
      "202bc67d4d5c95deeb7ea47713d84515e880f88a9851fa4c1e657a28f635fcce840bdd0b43899a443f01b7bb1cbb3d46936210e5d008da96400b2ef9cf6385ec04"
    ]
  }
